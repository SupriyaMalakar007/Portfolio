...
const bentoCategories = [
  {
    ...
    description:
      'Building intelligent systems using machine learning, natural language processing, data analysis, and practical AI techniques.',
    stat: 'AI / ML',
  ...
  },
  {
    ...
    description:
      'Strong programming foundation with a focus on problem solving, algorithms, data structures, and developing practical applications.',
    stat: '4 LANGUAGES',
  ...
  },
  {
    ...
    badge: 'DATA STACK',
    items: ['NumPy', 'Pandas', 'Scikit-Learn', 'MySQL', 'Excel'],
    description:
      'Working with data processing, analysis, machine learning workflows, databases, and tools for extracting meaningful insights.',
    stat: 'DATA DRIVEN',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    description:
      'Comfortable with modern development and data science environments for building, testing, analyzing, and presenting technical work.',
    stat: 'BUILD • TEST • ANALYZE',
    colSpan: 'lg:col-span-7',
  },
];
