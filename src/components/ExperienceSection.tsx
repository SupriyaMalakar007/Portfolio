...
const journey: RouteStop[] = [
  {
    ...
    organization: 'IBM LEARNING',
    description:
      'Worked on enterprise-focused AI and machine learning learning experiences, exploring practical tools, concepts, and business-oriented AI scenarios.',
  },
  {
    id: '02',
    year: 'FEB - MAR 2026',
    title: 'PYTHON FOR DATA SCIENCE INTERN',
    organization: 'VIRTUAL INTERNSHIP',
    description:
      'Applied Python for data science, working with data analysis concepts and practical workflows. Successfully completed the internship with an A+ grade.',
  },
  {
    id: '03',
    year: '2023 - ONGOING',
    title: 'B.TECH CSE — ARTIFICIAL INTELLIGENCE',
    organization: 'TECHNO INDIA UNIVERSITY, BIDHANNAGAR',
    description:
      'Pursuing a Bachelor of Technology in Computer Science Engineering with a specialization in Artificial Intelligence. Currently maintaining a CGPA of 8.40 with a latest SGPA of 9.16.',
  },
  {
    id: '04',
    year: '2021 - 2022',
    title: 'HIGHER SECONDARY',
    organization: 'MURARIPUKUR GOVT. SPONSORED H.S SCHOOL',
    description:
      'Completed higher secondary education with 86.6%, building a strong academic foundation for computer science and artificial intelligence.',
  },
  {
    id: '05',
    year: '2019 - 2020',
    ...
    organization: 'MURARIPUKUR GOVT. SPONSORED H.S SCHOOL',
    description:
      'Completed secondary education with 82.2%, establishing the foundation for my academic journey in technology.',
  },
];
